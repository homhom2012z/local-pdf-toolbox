...
const navigation = [
  ...
  { name: 'Extract Pages', href: '/extract' },
  { name: 'Convert to Image', href: '/convert' },
...
export default function Header() {
  ...
  return (
    <header className="bg-white shadow-sm border-b border-gray-200">
      <nav className="mx-auto flex max-w-screen-2xl items-center justify-between p-4 lg:p-6 xl:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">Local PDF Toolbox</span>
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-gray-900">Local PDF Toolbox</span>
            </div>
          </Link>
        </div>
